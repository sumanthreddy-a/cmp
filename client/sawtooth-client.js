      ...
      newTransactor(transactorOptions) {
        ...
        return {
          async post(payload, txnOptions) {
            ...
            //   var crypted = cipher.update(JSON.stringify(payloadBytes)).digest('hex');
            //   console.log(crypted)
              // console.log(createHash('sha512').update(cbor.encode(payload)).digest('hex'))
              // console.log(createHash('sha512').update(payloadBytes).digest('hex'))
              ...
              const transactionHeaderBytes = protobuf.TransactionHeader.encode({
                ...
                // payloadSha512: JSON.stringify(cbor.encode(payload),
